...
<head>
    ...
    <link rel="stylesheet" href="/err/style_records.css">
...
if ($result->num_rows > 0) {
    echo "<table border='1'>
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<td>" . $row['ToothID'] . "</td>";
                echo "<td>" . $row['ERRDepth'] . "</td>";
                echo "<td>" . $row['CBCTScanID'] . "</td>";
                echo "<td>" . $row['ScanDate'] . "</td>";
                echo "<td>" . $row['Diagnosis'] . "</td>";
                echo "<td>" . $row['TreatmentPlan'] . "</td>";
                echo "<td>
                        <a href='/err/update_record.php?id=" . $row['PatientID'] . "' class='btn btn-primary'><i class='fa-solid fa-pen-to-square'></i></a>
                        <a href='/err/delete_record.php?id=" . $row['PatientID'] . "' class='btn btn-danger' onclick='return confirmDelete()'><i class='fa-solid fa-trash'></i></a>
                      </td>";
                echo "</tr>";
            }
    echo "</table>";
...
echo"<button style='animation: fadeinleft 2s ease-in-out 1;' id='add_record'><a  href='/err/add_patients.php'>Add Record</a></button>";
$conn->close();
?>
