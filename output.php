...
<head>
    ...
    <link rel="stylesheet" href="/err/upload.css">
    <link rel="stylesheet" href="/err/outpup.css">
    <title>Output</title>
</head>
<body>
<header>
    ...
    <div class="background">
        <img class="plus_sign" src="/err/pictures/plus_signs_upload@300x.png" height="300rem">
        <img class="top_right" src="/err/pictures/right_top_corner@300x.png" height="280rem">
        <img class="left_bottom" src="/err/pictures/bottom_left_hp@300x.png" height="200rem">
        <img class="output_box" src="/err/pictures/output_con@300x.png" height="330rem" width="370rem">
    <main>
        <div class="buttons_processes">
            ...
            <label>
                <input value="value-6" name="value-radio" id="value-" type="radio">
            <span>6</span>
            </label>
