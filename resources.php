...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/err/style_reference.css">
    <link rel="stylesheet" type="text/css" href="/err/reference_bootstrap.min.css">
...
<header>
        ...
        <div id="header_options">
            ...
            if(isset($_SESSION['logged_in']) && $_SESSION['logged_in']==true){
                echo"
            <a href='/err/records.php' target='_blank'>Record</a>
                ";
            }
            else{
                echo"
            ...
            ?>
                ...
                <main>
                    <div class="card_container_resource">
                        <!-- Card-1 -->
                        ...
                        <br>
                        <div class="name">Causes and Diagnosis</div>
                        </div>
                        </div>
                        ...
                        <div class="wave"></div>
                            ...
                            <br>      
                            Cone Beam <br>Computed Tomography
                        <br>
                        <div class="name"><span>(CBCT)</span></div>
                        </div>
                        </div>
                        ...
                        Research Paper
                        <br>
                        <div class="name">BMC</div>
                        </div>
                        </div>
                    </div>
                    <div class="buttons">
                        <!-- Button-1 -->
                        <a href="https://pmc.ncbi.nlm.nih.gov/articles/PMC7185846/" target="_blank">
                            <button>
                                Read More
                            </button>
                        </a>
                        <!-- Button-2 -->
                        <a href="https://www.sciencedirect.com/topics/medicine-and-dentistry/cone-beam-computed-tomography" target="_blank">
                            <button>
                                Read More
                            </button>
                        ...
                        <!-- Button-3 -->
                        <a href="https://pmc.ncbi.nlm.nih.gov/articles/PMC10243707/#:~:text=In%20dentistry%2C%20artificial%20intelligence%20can,forensic%20dentistry%20for%20dental%20profiling." target="_blank">
                            <button>
                                Read More
                            </button>
                        </a>
                        <!-- Button-4 -->
                        <a href="https://www.bmcoralhealth.biomedcentral.com/articles/10.1186/s12903-024-03910-w" target="_blank">
                            <button>
                                Read More
                            </button>
                        </a>
     ...
     <footer>
        <div class="foot_block" id="footer_res">
