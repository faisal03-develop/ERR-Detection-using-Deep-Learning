...
<body>
    ...
    <main>
        ...
        <h1>About Us</h1>
            <p>Our mission is to revolutionize dental diagnostics with cutting-edge artificial intelligence. We aim to simplify and enhance the process of diagnosing External Root Resorption (ERR) using CBCT images.</p>

            <!-- <h2>Project Overview</h2>
            <p>This project combines machine learning and feature selection techniques to classify ERR depths accurately, offering insights for better treatment plans.</p> -->

            <h2>Meet the Team</h2>
            <ul>
                <li style="font-size: 14.4px; margin-left:3rem;">Supervising professor: 
                    <li class="names" ><b>DR. UZAIR ISHTIAQ</b></li>
                </li>
                <li style="font-size: 14.4px; margin-left:3rem;">Members:
                    <li class="names"><b>FAISAL ALTAF [FA-21-BCS-097]</b></li>
                    <li class="names" id="name2"><b>SAIF-ULLAH KHAN LODHI [FA-21-BCS-128]</b></li>
